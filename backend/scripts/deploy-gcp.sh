...
gcloud run deploy $BACKEND_SERVICE_NAME \
    ...
    --cpu 1 \
    --timeout 600 \
    --set-env-vars="NODE_ENV=production,SUPABASE_URL=$SUPABASE_URL,SUPABASE_ANON_KEY=$SUPABASE_ANON_KEY,SUPABASE_SERVICE_ROLE_KEY=$SUPABASE_SERVICE_ROLE_KEY,QDRANT_URL=$QDRANT_URL,QDRANT_API_KEY=$QDRANT_API_KEY,GOOGLE_AI_API_KEY=$GOOGLE_AI_API_KEY"
